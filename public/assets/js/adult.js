$(document).ready(function() {
  ...
  $(document).on('click', '#result-video-filter-paginate ul li a', function(e) {
    e.preventDefault();
    var action = $('#date-sort-video').attr('data-action') ? $('#date-sort-video').attr('data-action') : $('#chose-time-video').attr('data-action');

    console.log($('#date-sort-video'),'date-sort-video');
    console.log($('#chose-time-video'),'chose-time-video');
