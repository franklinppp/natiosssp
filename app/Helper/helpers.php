...
if(!function_exists('checkChannelSubscribe')) {
  function checkChannelSubscribe($channelId) {
    $channel = ChannelModel::find($channelId);
    return !empty($channel) && $channel->subscribe_status ? $channel->subscribe_status : 0;
  }
}
