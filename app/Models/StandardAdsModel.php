...
class StandardAdsModel extends Model  {
	...
	public static function get_standard_home(){
		$get_ads= StandardAdsModel::where(['position' => 'home','status' => 1])->take(1)->orderByRaw("RAND()")->first();
		if($get_ads!=NULL){
	...
	public static function get_standard_footer(){
		$get_ads= StandardAdsModel::where(['position' => 'footer','status' => 1])->where('status','=', '1')->take(4)->orderByRaw("RAND()")->get();
		if(count($get_ads)>0){
	...
	public static function get_standard_toprate(){
		$get_ads= StandardAdsModel::where(['position' => 'toprate','status' => 1])->take(1)->orderByRaw("RAND()")->first();
		if($get_ads!=NULL){
				if($get_ads->type=="upload"){
					$html="<a target='_new' href='".$get_ads->return_url."' title='".$get_ads->ads_title."'><img src='".$get_ads->ads_content."' style='max-height:269px'/></a>";
					return $html;
	...
	public static function get_standard_mostview(){
		$get_ads= StandardAdsModel::where(['position' => 'mostview','status' => 1])->take(1)->orderByRaw("RAND()")->first();
		if($get_ads!=NULL){
				if($get_ads->type=="upload"){
					$html="<a target='_new' href='".$get_ads->return_url."' title='".$get_ads->ads_title."'><img src='".$get_ads->ads_content."' style='max-height:269px'/></a>";
					return $html;
	...
	public static function get_standard_pornstar(){
		$get_ads= StandardAdsModel::where(['position'=>'pornstar','status' => 1])->take(1)->orderByRaw("RAND()")->first();
		if($get_ads!=NULL){
			if($get_ads->type=="upload"){
				$html="<a target='_new' href='".$get_ads->return_url."' title='".$get_ads->ads_title."'><img src='".$get_ads->ads_content."' style='max-height:269px'/></a>";
				return $html;
	...
	public static function get_standard_video(){
		$get_ads= StandardAdsModel::where(['position' => 'video', 'status' => 1])->take(6)->orderByRaw("RAND()")->get();
		return $get_ads;
		// if(count($get_ads) > 0){
	...
	public static function get_standard_belove_video(){
		$get_ads= StandardAdsModel::where(['position' => 'under_video', 'status' => 1])->take(1)->orderByRaw("RAND()")->first();
		if($get_ads!=NULL){
			if($get_ads->type=="upload"){
