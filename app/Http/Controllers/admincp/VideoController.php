...
class VideoController extends Controller {
	...
	public function post_editvideo(Request $get, $string_Id) {
		...
		if ($updatevideo) {
			VideoHelper::removeDetailCache($string_Id);
