...
<div class="bottom-header" style="">
	@if(!empty($config->banner1))
		<div class="col-md-6 col-sm-12 col-xs-12" style="padding: 0px;">
			<a href="{{$config->link1}}"><img src="{{url('public/upload/banner/'.$config->banner1)}}" alt="" width="100%" style="float: left;"></a>
		</div>
	@endif
	@if(!empty($config->banner2))
		<div class="col-md-6 col-sm-12 col-xs-12 hidden-xs hidden-sm" style="padding: 0px;">
			<a href="{{$config->link2}}"><img src="{{url('public/upload/banner/'.$config->banner2)}}" alt="" width="100%" style="float: left;"></a>
		</div>
	@endif
</div>
<div class="main-content">
	<div class="container-fluid">
		...
		<div class="titile-cate">{{trans('home.WATCHING_NOWS')}}</div>
