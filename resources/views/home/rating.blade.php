...
<div class="main-content">
    <div class="container-fluid">
        ...
        <div class="titile-cate">
            ...
            <ul>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true">{{trans('home.RATING')}}<span class="caret"></span></a>
                    <ul class="dropdown-menu" id="video-filter">
                        <li ><a href="javascript:void(0)" data-value="views">{{trans('home.VIEWS')}}</a></li>
                        <li class="active"><a href="javascript:void(0)" data-value="rating-video">{{trans('home.RATING')}}</a></li>
                    ...
                    <div class="col_img">
                        ...
                        <a href="{{URL(getLang().'watch')}}/{{$result->string_Id."/".$result->post_name}}.html">
                            <img data-preview ="{{$result->preview}}"
                                ...
                                class="js-videoThumbFlip img-responsive on-error-img"
