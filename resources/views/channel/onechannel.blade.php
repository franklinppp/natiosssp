...
if (isset($popular)) {
  if ($popular->website == "www.pornhub.com" or $popular->website == "www.maxjizztube.com" or $popular->website == "www.xvideos.com" or $popular->website == "www.youporn.com" or $popular->website == "www.4tube.com" or $popular->website == "lubetube.com" or $popular->website == "xhamster.com") {
	...
	json_encode([
		...
		'isBuy' => ($popular->buy_this == '1' || $channel->subscribe_status)? true : false,
...
<div class="main-content page-channel">
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-sm-4 col-xs-12 pull-left image-left">
				<div class="channel-left back-grey">
					<div  class="advertisement pull-left margin-l margin-t5">{{ $channel->title_name}}</div>
					<button type="button" id="on-subscriber" channel-data="{{ $channel->id}}" class="btn btn-default pull-right" style="background: none; border: none"><i class="fa fa-wifi"></i></button>
				</div>
				...
				<div class="channel-left margin-t10">
					...
					<div class="channel-total">
						...
						<span class="pull-right"><?php if(!empty($subscriber)) echo count($subscriber); ?></span>
					</div>
				</div>
				<div class="clearfix"></div>
			...
			<div class="col-sm-8 col-xs-12 image-rights" id="load-video">
				<video id="xstreamerPlayer" class="video-js vjs-default-skin box-boder" controls preload="none" data-setup='{}'  style="width:100%" height="480">
...
<script src="{{URL('public/assets/js/player.js?v='.time())}}" type="text/javascript" charset="utf-8"></script>
@endsection
