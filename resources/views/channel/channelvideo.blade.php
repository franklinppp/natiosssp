...
if (isset($addvideo)) {
	...
	json_encode([
		...
		'isBuy' => $addvideo->buy_this == '1' || checkChannelSubscribe($addvideo->channel_Id) ? true : false,
				...
				<div class="col-xs-6 col-sm-6 col-md-3">
					<div class="channel-col">
						...
						<a href="{{URL(getLang().'channel')}}/{{$result->id}}/{{$result->post_name}}">
                            <img src="{{url('/public/upload/channel/'.$result->poster)}}" src="{{$result->poster}}" alt="{{$result->title_name}}" class="img-responsive on-error-img" />
                        </a>
