...
<html lang="en">
	<head>
		...
		@if(Request::secure()) <meta http-equiv="Content-Security-Policy" content="upgrade-insecure-requests"> @endif
		...
		<link href="{{url('public/assets/font/BAUHS93/font.css')}}" rel="stylesheet" type="text/css">
		...
		<?php if($config->site_theme=="dark"): ?>
			<link href="{{URL::asset('public/assets/font-end/styles.css?v=1')}}" type="text/css" rel="stylesheet">
		<?php else: ?>
			<link href="{{URL::asset('public/assets/font-end/styles-v3.css?v=1')}}" type="text/css" rel="stylesheet">
		<?php endif;?>
		{{-- !!! TODO: temporary fix load sync, check where and why load async later --}}
