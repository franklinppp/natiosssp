		...
		$.ajax({
			...
			success:function(data){
				if(data.status === 200) {
					...
					$('#upload-msg').html('<div class="alert alert-danger"><span class="glyphicon glyphicon-remove"></span><strong>{{trans("home.SOMETHING_WRONG")}}</strong></div>').fadeIn().delay(3000).fadeOut();
				}
