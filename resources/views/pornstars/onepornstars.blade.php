            ...
            <div class="userNav">
                ...
                <div class="profileLeft hidden-xs">
                    <div id="msg-rating" class="rate">
                        <a href="javascript:void(0);" id="pornvote-like-{{$pornstar->id}}"  class="tt vUp" title="Like"><i class="fa fa-thumbs-up"></i><span>{{$pornstar_like}}</span></a>
                        <a href="javascript:void(0);" id="pornvote-dislike-{{$pornstar->id}}" class="tt vDn" title="Dislike"><i class="fa fa-thumbs-down"></i><span>{{$pornstar_dislike}}</span></a>
                        <span class="result">
