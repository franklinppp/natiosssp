    			...
    			<tbody>
    				...
    				<tr>
        				...
        				<td class="line_table">
        					...
        					<?=($result->status==3)?'<span data-toggle="tooltip" data-placement="top" title="Click here to approve" data-id="'.$result->id.'" class="approve-channel label label-info pointer">Register</span>':''?>
...
<script type="text/javascript">
	$(document).ready(function(){
    	...
    	$(document).on('click','.approve-channel',function(){
